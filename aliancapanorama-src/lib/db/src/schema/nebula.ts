...
export type InsertNebulaIa = z.infer<typeof insertNebulaIaSchema>;
export type InsertBibliotecaDoc = z.infer<typeof insertBibliotecaDocSchema>;
export type InsertAulia = z.infer<typeof insertAuliaSchema>;

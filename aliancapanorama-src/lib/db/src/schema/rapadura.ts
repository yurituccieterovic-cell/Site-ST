...
export const rapaduraFundosTable = pgTable("rapadura_fundos", {
  ...
  fonte: text("fonte"),
  nivelConfianca: integer("nivel_confianca").default(50),
  dossie: jsonb("dossie").default({}),
  ultimaAtualizacaoDossie: timestamp("ultima_atualizacao_dossie", { withTimezone: true }),

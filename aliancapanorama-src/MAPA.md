...
| 60 | AGE/LAR/GASTADOR: implementar schema Drizzle (domestico.ts, patient_profiles, agenda_slot) + rotas /api/lisange/* /api/lar/* /api/gastador/* | — | ⏳ |
| 61 | Webhook /api/webhooks/external-voice (X-Webhook-Secret) para integração multi-cloud | — | ⏳ |
| 62 | Sanitizar todos os inputs externos contra injeção de prompt antes de tocar contexto de IA | — | ⏳ |
